...
public class MainGUI extends JFrame {
    ...
    private MyLinkedList sessionList = new MyLinkedList(null,null);
    ...
    private void addSession() {
        try {
            ...
            /* TODO: Create Session object and based on id call:
               ...
               - insertAfter
            */
            sessionList.add(new Session(id,titleField.getText(),mentorField.getText(),departmentField.getText(),dateField.getText(),timeField.getText(),locationField.getText(),max));
    ...
    private String searchSessionByID() {
        try {
            int id = Integer.parseInt(idField.getText());
            return sessionList.searchByID(id);
        } catch(Exception _) {}
        return "Not Found";
    }
    ...
    private void removeSession() {
    	...
    	*/
        ...
        try {
            ...
            if (s == null) outputArea.setText("Session not found");
            else sessionList.remove(s);
        } catch (Exception _) { outputArea.setText("Session not found"); }
    }
